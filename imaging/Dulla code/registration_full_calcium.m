function [combined, andorscaled, cookscaled, L_R_OffsetFactor, U_D_OffsetFactor]=registration_full_calcium(Andor_Images, path, ScaleFactor, L_R_OffsetFactor, U_D_OffsetFactor, andormin, andormax) 
...
Andor=Andor-andormin;
Andor=Andor*128/((andormax)-(andormin));
