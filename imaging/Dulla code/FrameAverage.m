function [AveragedFrame]=FrameAverage(Input, StartFrame, EndFrame);
% **  function
...
for i= StartFrame:EndFrame
    tempFrame=Input(:,:,i);
    tempFrame=tempFrame*(1/(EndFrame-StartFrame+1));
    if i-StartFrame+1==1
        AveragedFrame=tempFrame;
    else
        AveragedFrame=AveragedFrame+tempFrame;
    end
