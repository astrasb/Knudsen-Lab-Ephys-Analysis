function [BW_RGBCustom]=CreateBW_RGBColorTable;
        PaletteSize=256;
        ...
        for i=RGB_QuadrantSize+1:2*RGB_QuadrantSize
            RGBCustom(i+BW_Size,1)=((RGB_QuadrantSize*2-i)*RGB_PaletteStepSize)/255;
        ...
        for i=RGB_QuadrantSize*2+1:3*RGB_QuadrantSize
            ...
            RGBCustom(i+BW_Size,2)=Saturated/255;
            RGBCustom(i+BW_Size,3)=((i-RGB_QuadrantSize*2)*RGB_PaletteStepSize-1)/255;
        end
        
        
        for i=RGB_QuadrantSize*3+1:4*RGB_QuadrantSize
            RGBCustom(i+BW_Size,1)=0/255;
            RGBCustom(i+BW_Size,2)=(RGB_QuadrantSize*4-i)*RGB_PaletteStepSize/255;
