function [PBT,AIT,MIT,Filtered_Max, AIT_NS]=ThresholdCounter_streamlined(ImagesToThreshold, Tmean, Tstd, Start, End, STDFactor,ThresholdCycle, Outside_Mask,Starting_Fret_Ratio_for_Thresholds,BaselineFretIntensity );
for frame=Start:End
